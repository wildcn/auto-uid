    ...
    _createClass(ProjectReplaceVUE, [{
        ...
        value: function process() {
            ...
            this.allFile.map(function (filepath, index) {
                ...
                _this2.curContent = _fsExtra2.default.readFileSync(filepath, { encoding: _this2.info.feuid2.encoding || 'utf8' });
                ...
                if (_this2.tagInfo.content != _this2.tagInfo.newContent) {
                    ...
                    _fsExtra2.default.writeFileSync(filepath, _this2.tagInfo.newContent, { encoding: _this2.info.feuid2.encoding || 'utf8' });
