...
exports.getMinTimeByArray = getMinTimeByArray;
/* 数字 格式化*/
function numberFormatter(num, digits) {
  var si = [{ value: Math.pow(1024, 6), symbol: 'E' }, { value: Math.pow(1024, 5), symbol: 'P' }, { value: Math.pow(1024, 4), symbol: 'T' }, { value: Math.pow(1024, 3), symbol: 'G' }, { value: Math.pow(1024, 2), symbol: 'M' }, { value: Math.pow(1024, 1), symbol: 'k' }];
...
function getMinTimeByArray(data) {
  var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'expireTime';
